...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    public static void main(String[] args) {
        ...
        int m = 100; // The number of repetitions
        int n = 1000; // The size of the array
        for (int k = 0; k < 5; k++) {	
            Integer[] array = new Integer[n];
            Integer[] arrayo = new Integer[n];
            Integer[] arraypo = new Integer[n];
            Integer[] arrayvo = new Integer[n];
            for (int i = 0; i < n; i++) {
                array[i] = random.nextInt();
            
            arrayo[i]=i; arrayvo[i]=n-i;
            if(i<n/2) {
            	arraypo[i]=i;
            }else {
            	arraypo[i]=random.nextInt();
            }
            }
            System.out.print("InsertionSort random:" + m);
            System.out.print("InsertionSort partially-order:" + m);
            System.out.print("InsertionSort reverse-order:" + m);
            System.out.print("InsertionSort order:" + m);
            n = n * 2;
